...
import '../homepage_one_page/widgets/sectionlisttrending_item_widget.dart';
...
class HomepageOnePage extends StatefulWidget{
  ...
  @override
  _HomepageOnePage createState() => _HomepageOnePage();
}

class _HomepageOnePage extends State<HomepageOnePage> {
  var db = new Mysql();
  var cafesList = [];

  void _getCafes() async {
    // db.getConnection().then((conn) => {
    //     conn.query('SELECT * FROM cafe;').then((results) {
    //          setState(() {
  ...
  onTapColumnuser(BuildContext context) {
    Navigator.push(context, MaterialPageRoute(builder: (context) => RestaurantsByLocationFilteredScreen()));
  }
